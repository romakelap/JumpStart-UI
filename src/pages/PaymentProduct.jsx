                    ...
                    <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                            ...
                            <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                                <div className="flex flex-col rounded-lg bg-white sm:flex-row">
                                    ...
                                    <div className="flex w-full flex-col px-4 py-4">
                                        ...
                                        <p className="float-right text-gray-400">*make sure this your product you want</p>
                            ...
                            <form className="mt-5 ml-[-5px]">
                                <div className="relative">
                                    <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlFor="radio_1">
                                        ...
                                        <div className="ml-5">
                                            <span className="mt-2 font-semibold">PayPal payment</span>
                        ...
                        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                            ...
                            <div className>
                                ...
                                <div className="relative">
                                    <input type="text" id="name" name="name" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="your full name" onChange={(e) => setCustomerName(e.target.value)} required />
                                ...
                                <div className="relative">
                                    <input type="text" id="address" name="address" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Your detail address here" onChange={(e) => setAddress(e.target.value)} required/>
                                    <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
