...
// 4. Click buy then redirect to paypal (inform user that payment will be using paypal)
// 5. Change PayPal button to PayPal's logo [DONE]
// 6. Fix navbar & footer issue
                ...
                <div className="grid grid-cols-2 gap-10 p-10 h-[50%]">
                    ...
                    <div>
                        <div className="flex justify-between">
                            <div>
                                <h1 className="text-2xl font-bold">Vivo GEN-12</h1>
                                <p>$520,99</p>
                            </div>
                        ...
                        <div className="my-5 h-fit m-0 p-0">
                            ...
                            <button className="flex gap-1 items-center justify-center border-2 w-full py-2 rounded-lg border-transparent text-[#F9A826] font-semibold shadow active:shadow-none transition hover:bg-[#F9A826] hover:text-white group">
